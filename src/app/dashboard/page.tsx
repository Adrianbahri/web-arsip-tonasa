...
export default function Dashboard() {
  ...
  // Reset User Password via Admin Modal
  ...
  const handleCreateServiceRequest = async (e: React.FormEvent) => {
     ...
     let submitName = user?.name || "Staf PT Semen Tonasa";
     if (role === 'guest') {
  ...
  const handleExportExcel = () => {
     ...
     link.setAttribute("download", `Daftar_Web_Arsip_PT_Semen_Tonasa_${statusFilter}.csv`);
        ...
        <div className="space-y-6 w-full pb-10">
           <div className="pb-4 border-b border-hairline flex items-center gap-4">
              ...
              <div>
                 ...
                 <p className="text-ink-mute text-[12px] md:text-[14px]">
                    Lengkapi formulir untuk mengajukan peminjaman fisik dokumen atau kunjungan ke ruang arsip PT Semen Tonasa.
                 </p>
              </div>
           </div>
